...
class UserRecommendationsRequestSpec extends ObjectBehavior
{
    function let()
    {
        ...
        $this->beConstructedWith($client, 123, $params);
    }
    ...
    {
        $this->getSignedUrl()->shouldReturn('https://api.vidora.com/v1/users/123/recommendations?api_key=VidoraTest.7baffc459cd6047b7a059f697681c04e&category=comedy&expires=2016-01-01T00:00&limit=10&signature=qs4q30Fiop2u7hb9dATz9OG34VRTNMQA%2BOV7SP2eBQA');
    }
}
